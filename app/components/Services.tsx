...
const SERVICES: {
...
}[] = [
  {
    ...
    desc: "Burst pipes, floods and urgent failures — a certified plumber at your door, day or night.",
    featured: true,
  },
  {
    imageId: "pipeFitting",
    title: "Leak Detection & Repair",
    desc: "Pinpoint hidden leaks fast with non-invasive tools, then fix them for good.",
  },
  {
    imageId: "pipeFusion",
    title: "Drain Unblocking",
    desc: "Blocked sinks, toilets and drains cleared quickly, cleanly and without the mess.",
  },
  {
    imageId: "youngPlumber",
    title: "Pipe Repair & Replacement",
    desc: "Worn, corroded or damaged pipework repaired or fully replaced to last.",
  },
  {
    imageId: "faucet",
    title: "Bathroom & Kitchen",
    desc: "Taps, sinks, showers and full fit-outs installed with a flawless finish.",
  },
  {
    imageId: "boiler",
    title: "Boiler & Water Heater",
    desc: "Servicing, repair and installation of boilers, geysers and hot-water systems.",
  },
  {
    imageId: "fixtures",
    title: "Installations & Fixtures",
    desc: "Dishwashers, washing machines, toilets and fixtures fitted right, first time.",
  },
  {
    imageId: "toolbox",
    title: "Commercial Plumbing",
    desc: "Reliable maintenance and rapid response for offices, retail and hospitality.",
  },
];
    ...
    >
      <div>
        ...
        <p className="text-[14.5px] leading-[1.55] text-muted">
          Whatever the job, we can help. Tell us what&apos;s going on and
        ...
        <div className="mb-[42px] flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-[620px]">
            ...
            <h2 className="text-[clamp(30px,4.4vw,50px)] leading-[1.05] font-extrabold tracking-[-0.028em]">
              Plumbing &amp; heating, covered end to end
            </h2>
          </div>
          <p className="max-w-[340px] text-[16.5px] leading-[1.6] text-muted">
            From a 2am burst pipe to a planned bathroom refit — one number, one
            reliable team for it all.
          </p>
        </div>
        ...
        <div data-embla-viewport ref={emblaRef} className="md:hidden">
          <div className="-ml-4 flex">
            {SERVICES.map((service) => (
              <div key={service.title} className="min-w-0 flex-[0_0_86vw] pl-4">
